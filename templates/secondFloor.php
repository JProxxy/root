...
<head>
    ...
    <title>Rivan-Second Floor</title>
            ...
            <div class="dashboardDeviderLeft">
                ...
                <div class="dropdownCont">
                    ...
                    <div class="custom-dropdown">
                        <div class="dropdown-btn">
                            <span id="dropdownText">Second Floor</span>
                ...
                <script>
                    document.addEventListener("DOMContentLoaded", function () {
                        ...
                        const modelPath = "<?php echo '../assets/models/secondFloor.glb'; ?>"; // Ensure this path is correct
                ...
                <div class="deviceControl">
                    ...
                    <div class="devices">
                        <div class="lights">
                            <div class="imageandlightscont">
                                ...
                                <select class="lightDropdown" id="lightCategory" onchange="updateLightState()">
                                    <option value="FFLightOne">R1 Front</option>
                                    <option value="FFLightTwo">R1 Rear</option>
                                    <option value="FFLightThree">Hallway</option>
                                    <option value="FFLightFour">Comfort Room</option>
                                    <option value="FFLightFive">R2 Front</option>
                                    <option value="FFLightSix">R2 Rear</option>
                                </select>
                            </div>
                        ...
                        <div class="airConditionFF">
                            <div class="imagesandaccont">
                                <a href="../templates/acRemote.php">
                                    <img src="../assets/images/ac.png" alt="Air Condition" class="airconImage">
                                </a>
                                <!-- Dropdown for selecting air conditioner -->
                                <select class="acDropDown" id="acCategory" onchange="updateAirconState()">
                                    <option value="1" selected>Aircon 1</option>
                                    <option value="2">Aircon 2</option>
                                </select>
                            </div>
                            <p>Air Condition</p>
                            <span>Room 1</span>
            ...
            function downloadExcel() {
                fetch("../scripts/logs_firstFloor_Garage.php")
                    ...
                    .then(data => {
                        ...
                        XLSX.utils.book_append_sheet(wb, ws, "Logs_SecondFloor");

                        XLSX.writeFile(wb, "Logs_SecondFloor.xlsx");
                    })
