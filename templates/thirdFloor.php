            ...
            <div class="dashboardDeviderLeft">
                ...
                <div class="dropdownCont">
                    ...
                    <div class="custom-dropdown">
                        <div class="dropdown-btn">
                            <span id="dropdownText">Third Floor</span>
                ...
                <script>
                    document.addEventListener("DOMContentLoaded", function () {
                        ...
                        const modelPath = "<?php echo '../assets/models/thirdFloor.glb'; ?>";
                        ...
                        <div class="lights">
                            <div class="imageandlightscont">
                                ...
                                <select class="lightDropdown" id="lightCategory" onchange="updateLightState()">
                                    <option value="FFLightOne">Light 1 - Hallway</option>
                                    <option value="FFLightTwo">Light 2 - SR1 Front</option>
                                    <option value="FFLightThree">Light 3 - SR1 MidFront</option>
                                    <option value="FFLightFour">Light 4 - SR1 MidRear</option>
                                    <option value="FFLightFive">Light 5 - SR1 Rear</option>
                                    <option value="FFLightSix">Light 6 - Sink</option>
            ...
            function downloadExcel() {
                fetch("../scripts/logs_firstFloor_Garage.php")
                    ...
                    .then(data => {
                        ...
                        XLSX.utils.book_append_sheet(wb, ws, "Logs_ThirdFloor");

                        XLSX.writeFile(wb, "Logs_ThirdFloor.xlsx");
                    })
