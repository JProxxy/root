...
<head>
    ...
    <title>Rivan-Fourth Floor</title>
            ...
            <div class="dashboardDeviderLeft">
                ...
                <div class="dropdownCont">
                    ...
                    <div class="custom-dropdown">
                        <div class="dropdown-btn">
                            <span id="dropdownText">Fourth Floor</span>
                ...
                <script>
                    document.addEventListener("DOMContentLoaded", function () {
                        ...
                        const modelPath = "<?php echo '../assets/models/fourthFloor.glb'; ?>"; // Ensure this path is correct
                        ...
                        <div class="lights">
                            <div class="imageandlightscont">
                                ...
                                <select class="lightDropdown" id="lightCategory" onchange="updateLightState()">
                                    <option value="FFLightOne">Hallway</option>
                                    <option value="FFLightTwo">Room 1</option>
                                    <option value="FFLightThree">Office</option>
                                    <option value="FFLightFour">SR2 Front</option>
                                    <option value="FFLightFive">SR2 Mid</option>
                                    <option value="FFLightSix">SR2 Rear</option>
                                </select>
                            </div>
            ...
            function downloadExcel() {
                fetch("../scripts/logs_firstFloor_Garage.php")
                    ...
                    .then(data => {
                        ...
                        XLSX.utils.book_append_sheet(wb, ws, "Logs_FourthFloor");

                        XLSX.writeFile(wb, "Logs_FourthFloor.xlsx");
                    })
